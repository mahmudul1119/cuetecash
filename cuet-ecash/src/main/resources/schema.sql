...
CREATE TABLE hall_fee (
    hall_fee_id BIGINT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE semester_fee (
    semester_fee_id BIGINT PRIMARY KEY AUTO_INCREMENT,
    semester_id INT NOT NULL,
    batch_no INT NOT NULL,
...
CREATE TABLE payment (
    ...
    semester_fee_id BIGINT,
    hall_fee_id BIGINT,
    payment_status ENUM('PENDING', 'APPROVED', 'COMPLETED', 'FAILED', 'REFUNDED') DEFAULT 'PENDING',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
